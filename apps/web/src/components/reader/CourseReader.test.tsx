...
describe("CourseReader", () => {
  ...
  it("does not render the course-scope band — it lives in the Overview, not the Lessons view", () => {
    // Arrange — a course carrying a computed scope band. The Overview owns that orientation framing
    // (CourseOverview renders the band); the Lessons reader must not repeat it.
    ...
    // Assert — no scope band anywhere in the Lessons view, even at the entry lesson.
