/** The glyphs both product rails use. Studio's own destinations keep their icons beside Studio's
 *  rail; these two are here because a second rail needed exactly them (journey
 *  live-session-lifecycle, T7) and a copied SVG is a copy that drifts. */
